            ...
            <div className="control-bars">
                ...
                <Form.Control as="select" className="party-group">
                    {partyGroups.map((party, index) => (
                        <option key={index} className={`p${index + 1}`}>
                            파티{index + 1}
                        </option>
                    ))}
                </Form.Control>
                <Button variant="danger" className="atk-btn">
                    공격
                </Button>
                <Button variant="danger" className="sud-btn">
                    기습
                </Button>
                <Button variant="danger" className="stu-btn">
                    무력화
                </Button>
            </div>
