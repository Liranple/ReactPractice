            ...
            <div className="normal-char-info">
                <div className="normal-char-stat1">
                    ...
                    <label>
                        <FontAwesomeIcon
                            icon="fist-raised"
                            className="normal-atk-icon cc"
                        />
                        <input
                            type="number"
                            value="20"
                            min="0"
                            className="normal-char-atk"
                            disabled="true"
                        />
                    </label>
                    <label>
                        <FontAwesomeIcon
                            icon="shield-alt"
                            className="normal-def-icon cc"
                        />
                        <input
                            type="number"
                            value="10"
                            min="0"
                            className="normal-char-def"
                            disabled="true"
                        />
                    </label>
                </div>
